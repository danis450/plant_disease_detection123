...
import example.com.finalyearproject.camera_tf.CameraActivity;
import example.com.finalyearproject.camera_tf.ImageClassifier;
...
//        }
        ...
        if (actionBar!=null) {
            actionBar.setTitle("Plant Disease Detector");
        }
...
//        issue_recycler.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
    ...
    public void onIssueSelected(int adapterPos,IssueModel issueModel) {
        ...
        if (!TextUtils.isEmpty(result_st)) {
            ...
            mDataList.add(new TimeLineModel(row1, "2023-02-12 08:00", OrderStatus.ACTIVE,""));
            mDataList.add(new TimeLineModel(row2, "2023-02-11 21:00", OrderStatus.ACTIVE,""));
            mDataList.add(new TimeLineModel(row3, "2023-02-11 18:00", OrderStatus.ACTIVE,""));
        } else {
            mDataList.add(new TimeLineModel(issueModel.getIssueName(), "2023-02-12 08:00", OrderStatus.INACTIVE, ""));
            mDataList.add(new TimeLineModel(issueModel.getIssueDesc(), "2023-02-11 21:00", OrderStatus.INACTIVE, ""));
            mDataList.add(new TimeLineModel(issueModel.getIssueSymptoms(), "2023-02-11 18:00", OrderStatus.INACTIVE, ""));
        }
